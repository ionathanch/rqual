...
The ability to eliminate higher-level proofs of falsehood into lower-level terms
...
then they are indistinguishable by a \emph{lower} observer level $\ell_1$ by \emph{downgrading}.
